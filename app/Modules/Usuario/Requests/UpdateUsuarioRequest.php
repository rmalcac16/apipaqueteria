...
class UpdateUsuarioRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        ...
        return [
            ...
            'numero_documento'  => ['required', 'string', 'max:20', Rule::unique('users', 'numero_documento')->ignore($id)],
            'nombreCompleto'    => ['required', 'string', 'max:255', Rule::unique('users', 'nombreCompleto')->ignore($id)],

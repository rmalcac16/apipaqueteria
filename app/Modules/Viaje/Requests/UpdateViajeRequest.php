...
class UpdateViajeRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'conductor_id' => 'sometimes|exists:users,id',
            'agencia_origen_id' => 'sometimes|exists:agencias,id|different:agencia_destino_id',
            'agencia_destino_id' => 'sometimes|exists:agencias,id',
    ...
    public function messages(): array
    {
        return [
            ...
            'fecha_llegada_estimada.after_or_equal' => 'La llegada estimada debe ser posterior a la salida.',
